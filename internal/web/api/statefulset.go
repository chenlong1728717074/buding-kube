...
func (api *StatefulSetApi) Update(ctx *gin.Context) {
...
func (api *StatefulSetApi) Delete(ctx *gin.Context) {
...
func (api *StatefulSetApi) Rollout(ctx *gin.Context) {
...
func (api *StatefulSetApi) Apply(ctx *gin.Context) {
